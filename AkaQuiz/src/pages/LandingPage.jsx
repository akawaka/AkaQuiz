  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        >
          <rect fill="#DE1E7E" width="2000" height="1500" />
          <defs>
            <radialGradient id="a" gradientUnits="objectBoundingBox">
              <stop offset="0" stopColor="#F29E19" />
              <stop offset="1" stopColor="#DE1E7E" />
            </radialGradient>
            <linearGradient
              id="b"
              ...
              y2="750"
            >
              <stop offset="0" stopColor="#e85e4c" />
              <stop offset="1" stopColor="#DE1E7E" />
            </linearGradient>
            <path
              id="s"
          ...
          <g>
            <g>
              ...
              <circle fillOpacity="0.3" fill="url(#a)" r="3000" />
            </g>
          </g>
        </svg>
      </div>
      {!isGameStarted && !isLeaderboardVisible ? (
        <div className="relative z-10 p-8 bg-white rounded-lg shadow-md">
          <h1 className="text-4xl font-bold">Bienvenido sur le Quiz !</h1>
        ...
        <div className="relative z-10 p-4 bg-white rounded-lg shadow-md">
          <Leaderboard />
          <button
